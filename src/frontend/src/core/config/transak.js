...
export const TRANSAK_CONFIG = {
  ...
  // Transak base URLs
  widgetUrl: import.meta.env.VITE_TRANSAK_ENV === "PRODUCTION" ? "https://global.transak.com" : "https://staging-global.transak.com",
 ...
 * @param {string} fiatCurrency - Fiat currency (USD, EUR, GBP, etc)
 * @returns {string} Complete Transak URL
 */
export function generateTransakUrl(walletAddress, cryptoCurrency, fiatAmount, network = "ethereum", fiatCurrency = "USD") {
