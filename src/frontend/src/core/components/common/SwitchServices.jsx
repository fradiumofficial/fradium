...
export default function SwitchServices({ compact = false, color = "#9BE4A0" }) {
  ...
  const ButtonClasses = "group flex items-center justify-center bg-transparent w-12 h-12 rounded-full border border-white/10 hover:bg-white/5 transition-all duration-200 ease-out cursor-pointer";
