            ...
            <div className="py-4">
                ...
                <div className="mx-5 mb-3 flex items-center gap-3 py-3 px-4 rounded-2xl bg-white/5">
                  {contextHideBalance ? (
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" className="text-[#4942AA]">
                      <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <circle cx="12" cy="12" r="3" stroke="#4942AA" strokeWidth="2" />
                      <path d="M1 1l22 22" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ) : (
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" className="text-[#4942AA]">
                      <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7z" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <button className="w-full text-sm transition-colors group" onClick={handleCopyPrincipal} aria-label={copiedPrincipal ? "Copied" : "Copy Principal"}>
                <div className="mx-5 flex items-center gap-3 py-3 px-3 rounded-xl hover:bg-white/5">
                  {copiedPrincipal ? (
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-[#4942AA]">
                      <path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  ) : (
                    <img src="/assets/icons/copy-green.svg" alt="Copy Principal" style={{ filter: "brightness(0) saturate(100%) invert(29%) sepia(14%) saturate(2424%) hue-rotate(212deg) brightness(87%) contrast(96%)" }} />
                  )}
              ...
              <button className="w-full text-sm transition-colors group" onClick={() => window.open("https://fradium.gitbook.io/docs/introduction/why-fradium", "_blank")}>
                <div className="mx-5 flex items-center gap-3 py-3 px-3 rounded-xl hover:bg-white/5">
                  <svg width="16" height="16" fill="none" viewBox="0 0 24 24" className="text-[#4942AA]">
                    <circle cx="12" cy="12" r="10" stroke="#4942AA" strokeWidth="2" />
                    <line x1="12" y1="8" x2="12" y2="12" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" />
                    <line x1="12" y1="16" x2="12.01" y2="16" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" />
                  </svg>
              ...
              <button className="w-full text-sm transition-colors group" onClick={() => window.open("https://fradium.gitbook.io/docs", "_blank")}>
                <div className="mx-5 flex items-center gap-3 py-3 px-3 rounded-xl hover:bg-white/5">
                  <svg width="16" height="16" fill="none" viewBox="0 0 24 24" className="text-[#4942AA]">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <polyline points="14,2 14,8 20,8" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <line x1="16" y1="13" x2="8" y2="13" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <line x1="16" y1="17" x2="8" y2="17" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <polyline points="10,9 9,9 8,9" stroke="#4942AA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
              ...
              {showSettings && (
                <button
                  ...
                  <div className="mx-5 flex items-center gap-3 py-3 px-3 rounded-xl hover:bg-white/5">
                    <img src="/assets/icons/setting-green.svg" alt="Settings" style={{ filter: "brightness(0) saturate(100%) invert(29%) sepia(14%) saturate(2424%) hue-rotate(212deg) brightness(87%) contrast(96%)" }} />
              ...
              <div className="mx-5 mt-2 mb-2">
                <div className="rounded-full p-[1px] hover:bg-white/5">
                  <button
                    className="w-full h-12 rounded-full text-[#4942AA] font-medium border border-white/10"
                    onClick={() => {
                      navigate("/");
                      logout();
                    }}>
