...
export default function AnalyzeLoadingModal({ isOpen, onCancel }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-16 pl-4 pr-4 bg-black/50 backdrop-blur-md overflow-y-auto">
      <div className="w-full max-w-[375px] mx-auto pb-8">
        <div className="w-[375px] h-[495px] bg-[rgba(23,26,28,0.8)] backdrop-blur-[18px] rounded-3xl flex flex-col items-center p-9 gap-8 overflow-y-auto">
