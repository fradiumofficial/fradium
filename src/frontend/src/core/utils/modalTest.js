...
if (typeof window !== 'undefined') {
    ...
    console.log('🧪 Fradium Modal Test Utils loaded!');
    console.log('Available commands:');
    console.log('- window.fradiumModalTest.reset() - Reset modal untuk testing');
    console.log('- window.fradiumModalTest.status() - Cek status visit');
    console.log('- window.fradiumModalTest.firstVisit() - Simulasi kunjungan pertama');
    console.log('- window.fradiumModalTest.returningVisit() - Simulasi kunjungan berulang');
}
