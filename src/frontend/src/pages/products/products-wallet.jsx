...
const ProductsWallet = () => {
    return (
        <div className="relative min-h-screen mb-32 bg-[#000510] text-white font-inter w-full overflow-x-hidden">
            ...
            {/* Main Content */}
            <div className="relative z-10 flex flex-col items-center justify-center pt-40 pb-10 px-4">
                {/* Section label */}
                ...
                {/* Description */}
                <p className="text-[#B0B6BE] text-center text-base font-normal max-w-5xl mx-auto mt-2">
            ...
            <section className="w-full max-w-[1500px] mb-32 mx-auto flex flex-col md:flex-row items-center justify-between gap-x-12 gap-y-8 py-24 px-16">
                {/* Left: Text & Features */}
                <div className="flex-1 flex flex-col items-start justify-center">
                    ...
                    <h2 className="text-white text-[40px] font-medium leading-tight mb-12 max-w-2xl">Protect and manage your assets<br />with confidence</h2>
                    {/* Feature Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 w-full max-w-2xl">
                        ...
                        <div className="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-[#B0B6BE] text-[16px] font-normal leading-snug">Map the crypto projects<br />Identify wallet risks before any transaction</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-[#B0B6BE] text-[16px] font-normal leading-snug">Check and scan contracts for<br />vulnerabilities automatically</div>
                            </div>
                        </div>
                        {/* Analyze Address */}
                        <div className="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-[#B0B6BE] text-[16px] font-normal leading-snug">Check wallet address for<br />past fraud activity</div>
                            </div>
                        </div>
                        {/* History */}
                        <div className="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-[#B0B6BE] text-[16px] font-normal leading-snug">View past transactions and<br />scan records in one place</div>
                            </div>
                        </div>
                    </div>
                </div>
