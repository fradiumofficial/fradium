        ...
        <div className="relative z-10 flex flex-col items-center justify-center pt-14 pb-2 px-3">
          ...
          <div className="w-full flex justify-center mb-6">
            <div className="max-w-xs">
              <ButtonGreen size="sm" fontWeight="medium" icon="https://cdn.jsdelivr.net/gh/fradiumofficial/fradium-asset@main/icons/f-green.svg" iconSize="w-[14px] h-[14px] sm:w-[16px] sm:h-[16px]" textSize="text-[13px]" className="w-full whitespace-nowrap" onClick={handleLaunchWallet}>
                Launch Wallet
              </ButtonGreen>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-[1300px]">
          ...
          <div className="flex items-start justify-between gap-6 mb-12">
            ...
            <div className="shrink-0 hidden md:block pt-4">
              <ButtonGreen size="sm" fontWeight="medium" icon="https://cdn.jsdelivr.net/gh/fradiumofficial/fradium-asset@main/icons/f-green.svg" iconSize="w-[18px] h-[18px] md:w-[23px] md:h-[23px]" onClick={handleLaunchWallet}>
                Launch Wallet
              </ButtonGreen>
            </div>
          </div>
          ...
          <div className="flex justify-center pt-8 items-center">
            <div className="relative max-w-4xl w-full">
              <img src="https://cdn.jsdelivr.net/gh/fradiumofficial/fradium-asset@main/produc/macbook-wallet.webp" alt="MacBook with Fradium Wallet" className="w-full h-auto max-h-[500px] object-contain mx-auto" draggable={false} />
