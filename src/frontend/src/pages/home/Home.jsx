        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl pt-6 sm:pt-8 md:pt-12 lg:pt-14 px-4 sm:px-6">
          <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 md:gap-4">
            ...
            >
              ...
              {/* Bento artwork (positioned below button on mobile, right bottom on desktop) */}
              <div className="absolute right-[-5px] top-[60px] sm:right-[-10px] sm:top-[70px] md:right-[-64px] md:top-auto md:bottom-[-84px] w-[130px] sm:w-[150px] md:w-[350px] lg:w-[400px] pointer-events-none select-none floating-slow fraud-bg-hover">
            ...
            <div className="group relative min-h-[280px] sm:min-h-[320px] md:min-h-[320px] lg:min-h-[360px] overflow-hidden rounded-[16px] sm:rounded-[20px] border border-white/10 bg-[#000000]/60 p-3 sm:p-4 md:p-6 shadow-[0_16px_48px_rgba(0,0,0,0.40)] backdrop-blur-[2px] fraud-detection-hover card-entrance stagger-2">
              {/* Glow effect overlay */}
              <div className="fraud-glow"></div>
