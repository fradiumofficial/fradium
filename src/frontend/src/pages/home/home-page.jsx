    ...
    <>
      <section className={styles.heroAboutSection}>
        ...
        <div className={styles.heroContentWrapper}>
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Here is Your Digital Asset Guardian to <br /> Analyse. Protect.
        ...
        <div className={styles.aboutContent}>
          ...
          <h2 className={styles.aboutTitle}>
            Built to Secure Every Transaction
          </h2>
          <p className={styles.aboutDesc}>
            Fradium is a Web3 security platform dedicated to safeguarding
            digital asset transactions. We enable users to analyse wallet
            addresses and audit smart contracts before interacting with them.
            <br />
            Our mission: help you detect risks, avoid fraud, and engage with
            confidence across the blockchain ecosystem.
          </p>
          <div className={styles.aboutIllus}>
            <img
              src="/assets/images/illus.png"
              alt="Fradium About Illustration"
            />
          </div>
        </div>
      </section>
      ...
      <section className="w-full flex flex-col items-center mt-24 px-4">
        <div className="text-center mb-6">
          <div className="text-green-400 font-semibold tracking-widest text-sm mb-2">
            HOW IT WORKS
          </div>
          <h2 className="text-4xl md:text-5xl font-medium text-white mb-4">
            Simple Protection for Every Transaction
          </h2>
          <p className="text-[#B0B6BE] text-lg max-w-4xl mx-auto">
            Fradium simplifies blockchain security with two essential tools:
            address analysis and smart contract audit.
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            ...
            >
              ...
              <div className="text-[#B0B6BE] text-base">
                Fradium checks against fraud databases and performs risk
                analysis.
              </div>
            </div>
            {/* Step 3 */}
      ...
      <section className={styles.fradiumExtSectionWrapper}>
        <div className={styles.fradiumExtHeaderRow}>
          <div>
            <span className={styles.fradiumExtSectionLabel}>
              FRADIUM EXTENSION
            </span>
            <h2 className={styles.fradiumExtSectionTitle}>
              Security that follows you, anywhere you Browse
            </h2>
          </div>
        ...
        >
          <div className={styles.fradiumExtAboutContent}>
            <div className={styles.fradiumExtAboutText}>
              Fradium Extension is a browser tool designed to help you assess
              the safety of blockchain interactions as you navigate Web3
              platforms. After downloading and installing the extension, you can
              analyse wallet addresses and smart contracts directly from your
              browser. The extension runs checks in the background and displays
              risk information on the spot, so you can review potential threats
              without leaving the page or switching to another tool.
            </div>
            <div className={styles.fradiumExtAboutImage}>
              <img
                src="/assets/images/fradium-extension.png"
                alt="Fradium Extension"
                draggable="false"
              />
            </div>
          </div>
        ...
        >
          <div className={styles.fradiumExtAboutContent}>
            <div className={styles.fradiumExtAboutText}>
              To use the Fradium Extension, simply download and install it on
              your browser. Once installed, you have two ways to scan wallet
              addresses or smart contracts. You can highlight the address or
              contract on any page, right-click, and select 'Scan with Fradium'.
              Alternatively, you can open the extension, enter the address or
              contract manually, and click the analyse button to check its risk
              level. Both options give you clear results directly in your
              browser, so you can verify before interacting.
            </div>
            <div className={styles.fradiumExtAboutImage}>
              <img
                src="/assets/images/fradium-extension.png"
      ...
      <section className={styles.keyFeatureSection}>
        ...
        <div className={styles.keyFeatureContentWrapper}>
          {/* Fitur kiri atas */}
          <div
            className={`${styles.keyFeatureItem} ${styles.keyFeatureItemLeftTop}`}
          >
            <img
              src="/assets/images/icon-detecion.png"
              alt="Fraud Detection"
          ...
          {/* Fitur kiri bawah */}
          <div
            className={`${styles.keyFeatureItem} ${styles.keyFeatureItemLeftBottom}`}
          >
            <img
          ...
          {/* Fitur kanan atas */}
          <div
            className={`${styles.keyFeatureItem} ${styles.keyFeatureItemRightTop}`}
          >
            <img
            ...
            />
            <div>
              <div className={styles.keyFeatureItemTitle}>
          ...
          {/* Fitur kanan bawah */}
          <div
            className={`${styles.keyFeatureItem} ${styles.keyFeatureItemRightBottom}`}
          >
            <img
              src="/assets/images/icon-community.png"
          ...
          <div className={styles.keyFeatureImageWrapper}>
            <img
              src="/assets/images/fradium-wallet.png"
              alt="Fradium Wallet"
              className={styles.keyFeatureImage}
              draggable="false"
            />
          </div>
        </div>
