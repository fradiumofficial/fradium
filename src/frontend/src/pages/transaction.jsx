            ...
            {openReceive && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                    <div className="bg-[#23272F] px-6 py-8 w-full max-w-md rounded-lg shadow-lg relative flex flex-col gap-6">
                        ...
                        <div className="text-white text-xl font-semibold mb-2">Receive Coin</div>
                            ...
                            {receiveAddresses.map((item, idx) => (
                                <div key={item.label} className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center gap-2 bg-[#23272F] border border-[#393E4B] rounded px-3 py-2">
                                        ...
                                        <img src="/assets/icons/content_copy.svg" alt="Copy" className="w-5 h-5 cursor-pointer" />
                                    </div>
                                </div>
                            ))}
                        </div>
                        <CustomButton className="mt-2 w-full" onClick={() => setOpenReceive(false)}>
                            Done
                        </CustomButton>
                    </div>
                </div>
            ...
            {qrDetail.open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                    <div className="bg-[#23272F] px-6 py-8 w-full max-w-sm rounded-lg shadow-lg relative flex flex-col gap-6">
                        ...
                        <div className="text-white text-xl font-semibold mb-2">Receive {qrDetail.coin}</div>
                        <div className="flex flex-col items-center gap-2">
                            <img src={qrImages[qrDetail.coin]} alt="QR" className="w-40 h-40 object-contain bg-black rounded" />
            ...
            {openSend.open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
                    <div className="bg-[#23272F] px-6 py-8 w-full max-w-sm rounded-lg shadow-lg relative flex flex-col gap-6">
                        ...
                        <div className="text-white text-xl font-semibold mb-2">Send {openSend.coin}</div>
                        <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <div className="text-[#B0B6BE] text-sm mb-1">Amount ({openSend.coin?.toUpperCase() || ''})</div>
                                <input
                                    type="number"
                                    className="w-full bg-[#23272F] border border-[#393E4B] rounded px-3 py-2 text-[#B0B6BE] text-sm outline-none"
                                    placeholder="0.00"
                            ...
                            <div className="w-full flex flex-col gap-6 relative z-10">
                                ...
                                <div className=" rounded-lg p-4 mb-2">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="bg-white/5 rounded-lg px-4 py-3 flex flex-col">
                                            <span className="text-white text-base font-medium">0.8 BTC</span>
                                            <span className="text-[#B0B6BE] text-xs flex items-center gap-1 mt-1">
                                        ...
                                        <div className="bg-white/5 rounded-lg px-4 py-3 flex flex-col">
                                            <span className="text-red-400 text-base font-medium">89/100</span>
                                            <span className="text-[#B0B6BE] text-xs flex items-center gap-1 mt-1">
                                        ...
                                        <div className="bg-white/5 rounded-lg px-4 py-3 flex flex-col">
                                            <span className="text-white text-base font-medium">329 Days Ago</span>
                                            <span className="text-[#B0B6BE] text-xs flex items-center gap-1 mt-1">
                                ...
                                <div className="rounded-lg px-6 py-5 mb-2 border-l-2 border-[#F87171] relative overflow-hidden bg-white/5">
                                    ...
                                    <div className="relative z-10">
                                        <div className="text-white font-bold mb-2">Security Checks Not Passed</div>
                                        <ul className="flex flex-col gap-1">
                                            <li className="flex items-center gap-2 text-[#F87171] text-sm">
                                                ...
                                                <span className="text-white">No link to known scam addressed</span>
                                            </li>
                                            <li className="flex items-center gap-2 text-[#F87171] text-sm">
                                                <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="#F87171" /><path d="M8 12l2 2 4-4" stroke="#23272F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                                <span className="text-white">Suspicious transaction pattern detected</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
