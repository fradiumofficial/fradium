...
const ICON_404 = "https://cdn.jsdelivr.net/gh/fradiumofficial/fradium-asset@main/icons/404.png";
  ...
  return (
    <section className="relative bg-[#000510] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 mt-8 text-center">
        {/* <p className="text-[14px] font-medium tracking-[0.28em] text-[#C1FFC5]">PAGE NOT FOUND</p> */}
      </div>
