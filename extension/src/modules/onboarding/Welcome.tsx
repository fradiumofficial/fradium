...
function Welcome() {
  return (
    <div className="w-[375px] h-[600px] space-y-4 bg-[#25262B] text-white shadow-md p-[32px]">
      ...
      <h1 className="text-[20px] font-bold text-center mx-[50px]">Step Into Safer Web3 with Fradium</h1>
      ...
      <p className="text-[12px] text-center font-normal tracking-wide text-white/70">Start your safer crypto interactions with Fradium</p>
      <NeoButton icon={ArrowRight} iconPosition='right'>Create Wallet</NeoButton>
    </div>
  );
}
