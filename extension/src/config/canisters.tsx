export const CANISTERS = {
  frontend: process.env.PLASMO_PUBLIC_FRONTEND_URL!,
  ai: process.env.PLASMO_PUBLIC_AI_URL!,
  backend: process.env.PLASMO_PUBLIC_BACKEND_URL!,
  chatbot: process.env.PLASMO_PUBLIC_CHATBOT_URL!,
