...
function DetailHistory() {
  ...
  useEffect(() => {
    if (id) {
      ...
      // Dummy lookup
      const dummyItems: ScanHistoryItem[] = [
        {
          id: "scan_1",
          ...
          analysisResult: {
            aiData: { ransomware_probability: 0.12, confidence_level: "HIGH" },
          },
        },
        {
          id: "scan_2",
          ...
          analysisResult: {
            communityData: {
              report: [
                { votes_yes: 12, votes_no: 8, voted_by: ["u1", "u2"] },
              ],
            },
          },
        },
      ];
      const item = dummyItems.find((d) => d.id === id) || null;
