              ...
              <div className="w-[303px] h-[92px] flex flex-col justify-center items-start gap-2 self-stretch flex-grow-0">
                <form onSubmit={handleSubmit} className="w-full">
                  ...
                  <button
                    type="submit"
                    disabled={false}
                    className="w-[303px] h-[40px] box-border flex flex-row justify-center items-center p-[10px_20px] gap-[6px] bg-gradient-to-br from-[#99E39E] to-[#4BB255] shadow-[0px_5px_8px_-4px_rgba(153,227,158,0.7),0px_0px_0px_1px_#C0DDB5] rounded-[99px] mt-2 self-stretch flex-grow-0 hover:shadow-[0px_8px_12px_-4px_rgba(153,227,158,0.9),0px_0px_0px_1px_#C0DDB5] hover:from-[#A8E8A8] hover:to-[#5BBF65] active:scale-95 transition-all duration-200 ease-in-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#99E39E] focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {/* Icon placeholder */}
                    <div className="w-[20px] h-[20px] relative">
                      <div className="absolute w-[15.14px] h-[17px] left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <img src={CDN.icons.policyAlert} alt="Analyze Address" className="w-[15.14px] h-[17px] transition-transform duration-200 hover:scale-110" />
                      </div>
                    </div>
