...
export type BlockTag = { 'Safe' : null } |
  { 'Finalized' : null } |
  { 'Latest' : null };
...
export interface Eip1559TransactionPriceArg { 'ckerc20_ledger_id' : Principal }
...
export type RetrieveEthStatus = { 'NotFound' : null } |
...
export interface UnsignedTransaction {
  ...
  'gas_limit' : bigint,
  'access_list' : Array<
    { 'storage_keys' : Array<Uint8Array | number[]>, 'address' : string }
  >,
}
