...
export type AccountData = { 'json' : ParsedAccount } |
  { 'legacyBinary' : string } |
  { 'binary' : [string, AccountEncoding] };
export type AccountEncoding = { 'base64+zstd' : null } |
  { 'jsonParsed' : null } |
  { 'base58' : null } |
  { 'base64' : null } |
  { 'binary' : null };
...
export interface DataSlice { 'offset' : number, 'length' : number }
export interface EncodedConfirmedTransactionWithStatusMeta {
  'transaction' : EncodedTransactionWithStatusMeta,
  'slot' : Slot,
  'blockTime' : [] | [Timestamp],
}
export type EncodedTransaction = { 'legacyBinary' : string } |
...
export type GetAccountInfoEncoding = { 'base64+zstd' : null } |
  { 'jsonParsed' : null } |
  { 'base58' : null } |
  { 'base64' : null };
...
export type GetAccountInfoResult = { 'Ok' : [] | [AccountInfo] } |
  { 'Err' : RpcError };
...
export type GetBalanceResult = { 'Ok' : Lamport } |
  { 'Err' : RpcError };
...
export type GetBlockResult = { 'Ok' : [] | [ConfirmedBlock] } |
  { 'Err' : RpcError };
...
export type GetSlotResult = { 'Ok' : Slot } |
  { 'Err' : RpcError };
...
export type GetTokenAccountBalanceResult = { 'Ok' : TokenAmount } |
  { 'Err' : RpcError };
...
export type MultiGetSlotResult = { 'Consistent' : GetSlotResult } |
...
export type MultiRequestResult = { 'Consistent' : RequestResult } |
...
export interface RpcProvider { 'access' : RpcAccess, 'cluster' : SolanaCluster }
export type RpcSource = { 'Custom' : RpcEndpoint } |
  { 'Supported' : SupportedProvider };
export type RpcSources = { 'Default' : SolanaCluster } |
  { 'Custom' : Array<RpcSource> };
export type SendTransactionEncoding = { 'base58' : null } |
  { 'base64' : null };
...
export type SendTransactionResult = { 'Ok' : Signature } |
  { 'Err' : RpcError };
...
export type SolanaCluster = { 'Mainnet' : null } |
  { 'Testnet' : null } |
  { 'Devnet' : null };
export type SupportedProvider = { 'AnkrMainnet' : null } |
  { 'AlchemyDevnet' : null } |
  { 'DrpcMainnet' : null } |
...
export type TransactionConfirmationStatus = { 'finalized' : null } |
  { 'confirmed' : null } |
  { 'processed' : null };
export type TransactionDetails = { 'none' : null } |
  { 'accounts' : null } |
  { 'signatures' : null };
export type TransactionError = { 'ProgramCacheHitMaxLimit' : null } |
...
export interface _SERVICE {
  ...
  'getTransactionCyclesCost' : ActorMethod<
    ...
    RequestCostResult
  >,
  'jsonRequest' : ActorMethod<
    [RpcSources, [] | [RpcConfig], string],
    MultiRequestResult
  >,
  'jsonRequestCyclesCost' : ActorMethod<
    [RpcSources, [] | [RpcConfig], string],
    RequestCostResult
  >,
  ...
  'updateApiKeys' : ActorMethod<
    [Array<[SupportedProvider, [] | [string]]>],
    undefined
  >,
}
