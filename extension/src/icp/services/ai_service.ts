...
export const analyzeBtcAddress = async (features: number[], address: string, featureCount: number): Promise<RansomwareAnalysisResponse> => {
  try {
...
export const analyzeEthAddress = async (features: [string, number][], address: string, transactionCount: number): Promise<RansomwareAnalysisResponse> => {
  try {
